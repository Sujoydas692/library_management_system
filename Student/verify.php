...
$qry = mysqli_query($con, "SELECT `token`,`status` FROM `student` WHERE `status` = 0 AND `token` = '$token' LIMIT 1");
if (mysqli_num_rows($qry) == 1) {
    $update = mysqli_query($con, "UPDATE `student` SET `status` = 1 WHERE `token` = '$token' LIMIT 1"); ?>
     <div class="wrap">
    <!-- page BODY -->
    <!-- ========================================================= -->
    <div class="page-body">
