                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <tr>
                                               ...
                                               <td>
                                                   ...
                                                   <a href="delete-book.php?bookdelete=<?= base64_encode($row['id']) ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete?')"><i class="fa fa-trash-o"></i></a>
                                               </td>
                                            </tr>
                                            <?php
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="form-group">
                                            <label for="book_image">Book Image</label>
                                                <img src="../images/books/<?= $book_info_row['book_image'] ?>" width = '100'>
                                        </div>
                                        <div class="form-group">
                                            <label for="book_author_name">Author Name</label>
                                                <input type="text" class="form-control" name="book_author_name" id="book_author_name" placeholder="Book Author Name" value="<?= $book_info_row['book_author_name'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="book_publication_name">Publication Name</label>
                                                <input type="text" class="form-control" name="book_publication_name" id="book_publication_name" placeholder="Book Name" value="<?= $book_info_row['book_publication_name'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="book_purchase_date">Purchase Date</label>
                                                <input type="date" class="form-control" name="book_purchase_date" id="book_purchase_date" value="<?= $book_info_row['book_purchase_date'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="book_price">Book Price</label>
                                                <input type="text" class="form-control" name="book_price" id="book_price" placeholder="Book Price" value="<?= $book_info_row['book_price'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="book_qty">Book Quantity</label>
                                                <input type="text" class="form-control" name="book_qty" id="book_qty" placeholder="Book Quantity" value="<?= $book_info_row['book_qty'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="available_qty">Available Quantity</label>
                                                <input type="text" class="form-control" name="available_qty" id="available_qty" placeholder="Available Quantity" value="<?= $book_info_row['available_qty'] ?>">
                                        </div>
                                        <div class="form-group">
